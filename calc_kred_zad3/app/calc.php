...
function validate(&$form,&$infos,&$msgs,&$hide_intro){
	...
	if ( $form['y'] == "") $msgs [] = 'Nie podano liczby lat spłaty';
	...
	if ( count($msgs)==0 ) {
		...
		if (! is_numeric( $form['y'] )) $msgs [] = 'Liczba lat nie jest liczbą całkowitą';
		if (! is_numeric( $form['z'] )) $msgs [] = 'Oprocentowanie nie jest liczbą całkowitą';
	}
...
function process(&$form,&$infos,&$msgs,&$result){
	$infos [] = 'Parametry poprawne. Obliczam!';
...
$smarty->assign('page_description','Oblicz wysokość swoich rat!');
